...
export default function PausadasView({ onTareaClick }) {
  ...
  const cargarTareasPausadas = async () => {
    ...
    try {
      ...
      console.log("🔍 Estados pausados encontrados:", estadosPausados);
      ...
      console.log("📋 IDs de estados pausados:", idsPausados);
      ...
      console.log("✅ Tareas pausadas cargadas:", data?.length || 0);
